    ...
    <div class="header-links">
      ...
      <Link to="/dev-portfolio" class="header-links-hover">
        ...
        <div class="header-links-right">
          ...
          <span class="absolute inset-0 w-full h-full transition duration-200 ease-out transform group-hover:-translate-x-1 group-hover:-translate-y-1 bg-primary border-2 border-primary group-hover:bg-primary rounded"></span>
          <span class="flex items-center gap-2 relative text-text group-hover:text-white rounded transition duration-200 ease-out transform group-hover:-translate-x-1 group-hover:-translate-y-1">
